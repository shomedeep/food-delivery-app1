...
var GenerateSignature = function (payload) {
    return jsonwebtoken_1.default.sign(payload, config_1.APP_SECRET_KEY, { expiresIn: "90d" });
};
...
var ValidateSignature = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, jsonwebtoken_1.default.verify(signature.split(" ")[1], config_1.APP_SECRET_KEY)];
            case 2:
                payload = (_a.sent());
                req.user = payload;
