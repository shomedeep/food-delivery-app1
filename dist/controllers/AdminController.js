...
var CreateVandor = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, address, pincode, foodType, email, password, ownerName, phone, existingVandor, salt, usePassword, createdVandor;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                vandors = _a.sent();
                if (vandors !== null) {
                    return [2 /*return*/, res.json({ count: vandors.length, data: vandors })];
                }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, res.status(404).json({ message: "vandor data not found" })];
        }
    });
}); };
