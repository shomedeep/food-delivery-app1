...
var CustomerVerify = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3: return [2 /*return*/, res.status(400).json({ message: "Error with OTP verification" })];
        }
    });
}); };
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                _a.label = 2;
            case 2: return [2 /*return*/, res.status(400).json({ message: "Error with fetching profile data" })];
        }
    });
}); };
exports.GetCustomerProfile = GetCustomerProfile;
var EditCustomerProfile = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var customer, profileInputs, validationError, firstName, lastName, address, profile, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                customer = req.user;
            ...
            case 3:
                ...
                _a.label = 4;
            case 4: return [2 /*return*/, res.status(400).json({ message: "Error with updating profile" })];
        }
    });
}); };
